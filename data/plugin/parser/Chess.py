...
class Parser:
	...
	menu = '<div class="movemenu"><a id="' + self.name + '-previous_move" href="#jslink">Previous</a> | <a id="' + self.name + '-next_move" href="#jslink">Next</a> &nbsp;&nbsp;&nbsp;<b>&mdash; &mdash;</b>'
	...
	for i, move in enumerate(moves):
	   if ( i % 2 == 0 ):
	      ...
	      move_link = '<a href="#jslink" id="' + board_switch + '">' + move + '</a> &nbsp;'
